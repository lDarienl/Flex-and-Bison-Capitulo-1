...
#line 16 "fbejemplo5.y"
                         { printf("= %d\n", yyvsp[-1]); }
#line 1072 "fbejemplo5.tab.c"
    break;

  case 5: /* exp: exp ADD factor  */
#line 21 "fbejemplo5.y"
                         { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1078 "fbejemplo5.tab.c"
    break;

  case 6: /* exp: exp SUB factor  */
#line 22 "fbejemplo5.y"
                         { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1084 "fbejemplo5.tab.c"
    break;

  case 8: /* factor: factor MUL term  */
#line 27 "fbejemplo5.y"
                         { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1090 "fbejemplo5.tab.c"
    break;

  case 9: /* factor: factor DIV term  */
#line 28 "fbejemplo5.y"
                         { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1096 "fbejemplo5.tab.c"
    break;

  case 11: /* term: ABS term  */
#line 33 "fbejemplo5.y"
                         { yyval = yyvsp[0] >= 0 ? yyvsp[0] : -yyvsp[0]; }
#line 1102 "fbejemplo5.tab.c"
    break;


#line 1106 "fbejemplo5.tab.c"
